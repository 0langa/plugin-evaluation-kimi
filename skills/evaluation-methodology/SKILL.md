...
**Speed:** 20–90 seconds. One structured Codex call per skill by default. Non-deterministic.

The Codex judge reads the SKILL.md and supplied skill context, then scores four
...
**Speed:** 5–20 minutes. N=50 isolated Codex routing simulations (default). Statistical.
...
**Problem:** Without a meaningful description, the Codex skill router cannot determine
