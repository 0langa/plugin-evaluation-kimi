...
causes Codex to invoke the skill at the right times. A skill with perfect triggering
...
should not. It assesses whether the description would lead Codex's skill router to
...
Output quality measures whether the skill's instructions would guide Codex to produce
...
Following the skill's instructions would lead Codex to produce wrong answers or actively
