...
### Step 2: Codex Judge (Layer 2) — if NOT --depth quick

The CLI runs one isolated `codex exec` assessment with JSON Schema constrained output. The judge
returns scores for triggering accuracy, orchestration fitness, output quality, and scope calibration.
